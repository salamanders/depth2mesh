...
// --Commented out by Inspection STOP (5/18/20, 1:19 PM)
    ...
    static class SVDImpl {
        ...
        private static void applyTransform(double[][] a, int m, int k, int j) {
            double t = 0;
            for (int i = k; i < m; i++) {
                t += a[i][k] * a[i][j];
            }
